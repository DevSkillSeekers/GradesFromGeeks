...
import com.solutionteam.mindfulmentor.ui.presentation.mentor.SummeryDetailsUIState
...
fun MeetingItem() {
    Column(
       ...
       Row(
        ...
        GGButton(title = "Book now", onClick = { /*TODO*/ }, modifier = Modifier.padding( 8.dp).fillMaxWidth())
    }
}
